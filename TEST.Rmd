...
bscols(list(plot_ly(data=sd, x=~DateTime, y=~Temp) |> add_lines(), 
       plot_ly(data=sd, x=~DateTime, y=~DO) |>  add_lines(),
       plot_ly(data=sd, x=~DateTime, y=~pH) |>  add_lines(),
       plot_ly(data=sd, x=~DateTime, y=~SpCon) |>  add_lines()))
