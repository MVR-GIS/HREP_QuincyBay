...
library(shiny)
   ...
   selectInput("Project", 
            label = "Project", 
            choices = c("Quincy Bay")) 
    
    selectInput("Site", 
            label = "Monitoring Site", 
            choices = c("W-M329.5Y", "W-M329.8P"))
    
     selectInput("Monitoring Season", 
            label = "Monitoring Season", 
            choices = c("Winter 2020-2021", "Summer 2021", "Winter 2021-2022", "Summer 2022", "Winter 2022-2023", "Summer 2023"))
